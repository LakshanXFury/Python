...
""" The SQLALCHEMY_DATABASE_URI key is intended to hold a single default database connection string, not a dictionary. 
...
def register():
    ...
    if form.validate_on_submit():
        ...
        user = result.scalar()
        # A user is trying to register with an email that already exists in the database
        if user:
