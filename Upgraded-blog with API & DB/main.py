...
class CreatePostForm(FlaskForm):
    ...
    url = StringField("URL for the background image", validators=[DataRequired(), URL()])
    body = CKEditorField("Body of the message", validators=[DataRequired()])
