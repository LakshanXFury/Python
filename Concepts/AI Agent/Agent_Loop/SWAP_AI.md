...
WORKER_MODEL = os.environ.get("WORKER_MODEL", "gpt-4o-mini")  # cheaper: gpt-5.4-mini
```
...
```bash
ORCHESTRATOR_MODEL=gemini-3.1-flash-lite WORKER_MODEL=gpt-4o-mini uv run agent_loop.py
```
